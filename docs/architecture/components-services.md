...
| **Alert Manager** | reportRun(sourceId, runId, alerts[], scopes[]) · raiseAlert · resolveAlert · acknowledge · suppress. Four states, grouping, inhibition, escalation. Full spec: [alerting flow](flows-alerting.md) and [ADR-020](decisions.md#adr-020) | What a visa, a filing or a correlation rule is. It consumes severity; it never judges it |
